...
//!
//! Env vars: `BRIDGE_ENDPOINT` (default `http://127.0.0.1:8787`),
//! `DRYRUN_PROJECT` (default `telegram-dryrun`), `DRYRUN_TOKEN` (required ΓÇö that
...
async fn main() -> anyhow::Result<()> {
    let endpoint =
        std::env::var("BRIDGE_ENDPOINT").unwrap_or_else(|_| "http://127.0.0.1:8787".into());
