...
- **Ferryman** persists job state, policy/approval decisions, recovery memory, artifacts, and audit events.

When an agent or orchestrator loses context, a new or recovered actor loads Ferryman's project memory and job/event history. Ferryman does not decide what to do with that information.
